  ...
  const updateBookStatus = async (bookId: number, status: BookStatus) => {
    ...
    > = {
      active: {
        ...
        message:
          "Are you sure you want to make this listing visible to buyers again?",
        confirmText: "Unhide",
        cancelText: "Keep Hidden",
        successTitle: "Listing unhidden",
        successMessage: "The listing is now active again.",
      },
      reserved: {
        title: "Mark as Reserved?",
        message: "Are you sure you want to mark this listing as reserved?",
        confirmText: "Mark Reserved",
        cancelText: "Cancel",
        successTitle: "Listing updated",
        successMessage: "The listing is now marked as reserved.",
      },
      sold: {
        title: "Mark as Sold?",
        ...
        cancelText: "Cancel",
        successTitle: "Listing marked as sold",
        successMessage: "The listing is now marked as sold.",
      },
      hidden: {
        title: "Hide Listing?",
        message: "Are you sure you want to hide this listing from buyers?",
        confirmText: "Hide",
        cancelText: "Keep Visible",
        successTitle: "Listing hidden",
        successMessage: "The listing has been hidden successfully.",
      },
    };
    ...
    const confirmed = await confirm({
      ...
      danger: status === "sold" || status === "hidden",
    });
  ...
  const duplicateBook = async (book: Book) => {
    try {
      ...
      showToast({
        ...
        message: "A hidden copy of this listing was created successfully.",
        type: "success",
      });
    } catch (error) {
